...
class ShopPage extends StatelessWidget {
  ...
  static List<Shop> shopItems = [
    Shop(power: 'Fingers', amount: 2, effect: 'More coochies per tap', price: 69.0),
    Shop(power: 'Tim', amount: 1, effect: 'Get More Coochies each second', price: 420.0),
    Shop(power: 'Alcohol', amount: 17, effect: 'Multiplies the chances of getting laid', price: 720.0),
  ];
